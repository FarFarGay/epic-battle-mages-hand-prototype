...
## форма квартала. 3×3 с ШАХТОЙ В УГЛУ → 8 клеток зоны = ровно чеканный двор (L,4) + плавильня
## (1) + дом гномов (I,3) (двор на 180° + плавильня + дом точно замощают 8). DATA — дизайнер
## крутит форму/размер; offset'ы поворачиваются на ориентацию шахты (_plot_cells_ordered).
