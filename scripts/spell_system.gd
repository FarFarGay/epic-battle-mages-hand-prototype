...
const SPELL_CATALOG: Dictionary = {
	...
	&"arbalest_volley": {
		...
		"description": "Физическое оружие башни: арбалетные окна дают залп болтов по точке клика (ближайший враг у точки — цель). Стреляют, пока внутри башни спрятаны лучники («В башню»). Маны не тратит.",
		...
		"unlock_cost": {},
		"levels": [
			{"damage": 0.0, "cooldown": 0.5, "mana_cost": 0.0},
		],
		"upgrade_costs": [],
	},
	&"mine_scatter": {
