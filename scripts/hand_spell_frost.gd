...
## Те же параметры что у Fireball — frost-bolt летит идентично, отличается
## только эффектом импакта. Если нужен «отличный полёт» (медленнее / выше) —
## крутим именно эти @export'ы.
