...
const CATALOG: Dictionary = {
	...
	# Плавильня: гном-добытчик несёт сюда руду → СРАЗУ переплавка в монеты в казну
	# (монетная экономика). Группа &"smelter" — цель доставки гномов. 2 клетки: печь+труба.
	PAD_SMELTER: {
		"name": "Плавильня",
		"menu_label": "🔥 Плавильня (руда→монеты)",
		"role": &"smelter",
