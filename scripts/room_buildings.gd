...
const CATALOG: Dictionary = {
	...
	# Гейт ДВОЙНОЙ: институт (_magic_unlocked) И древний рецепт из пещеры
	# (PlayerProfile.fire_recipe_found — приносит GearElement). Шквал ушёл
	# Аккумулятору (KeystoneElement): «выстрел → залп» открывает артефакт храма.
	PAD_FIRE_LAB: {
		"name": "Кафедра огня",
		"menu_label": "🔥 Кафедра огня (шар)",
		"hint": "Школа огня: открывает Огненный шар. Требует институт и древний рецепт из пещеры гномов.",
		"role": &"spell_lab",
		"spells": [&"fireball"],
		"cells": [Vector2i(0, 0), Vector2i(1, 0)],
		"instant": true,
	...
	PAD_ENGINEER_LAB: {
		...
		"hint": "Куёт НАВЕСКИ башни: Гарпунная турель — клик по зданию (40🥉), аппарат ставится рукой на башню. Открывает Мины. Требует институт.",
		"role": &"spell_lab",
		"spells": [&"mine_scatter"],
		"cells": [Vector2i(0, 0), Vector2i(1, 0)],
		"instant": true,
