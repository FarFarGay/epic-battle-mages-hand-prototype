...
const CATALOG: Dictionary = {
	...
	# Барак — САПОРТ казармы (оборонный квартал): домино 2 клетки, ставится рядом с казармой (в её
	# зоне-силуэте, с внутренней стороны) → поднимает кап найма этой казармы (см. PadBuilding.
	# hire_cap_bonus). Категория DEFENSE. Несколько бараков складываются.
	PAD_BARRACK: {
		"name": "Барак",
		"menu_label": "⛺ Барак (+найм)",
		"hint": "Сапорт казармы: +кап найма. Ставь в зону казармы (внутри).",
		"role": &"barrack",
