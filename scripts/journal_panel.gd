...
func _build_debug_tab(camp: Node) -> void:
	...
	list.add_child(_build_cheat_card(
		"Бродячая банда",
		"Спавнит банду (100 скелетов) блобом у случайной зоны. Банда роумит когезивно по карте (каждый держит свою точку в строю, не сбиваясь в одного) и нападает на лагерь ТОЛЬКО если увидит. Шаг 1 осмысленной осады.",
		"банда",
		wd,
		func(): wd.cheat_spawn_warband(),
	))
	list.add_child(_build_cheat_card(
		"Штурм-банда (на лагерь)",
		"Спавнит банду (100) с 1 фронта, идущую ПРЯМО НА ЛАГЕРЬ (forced_target = башня), ломая стены по пути. Тест ночной осады без ожидания ночи.",
		"штурм",
		wd,
		func(): wd.cheat_spawn_assault(),
	))
	list.add_child(_build_cheat_card(
		"День ↔ Ночь",
		"Мгновенно переключить фазу. День = 0 направленного давления + бродячие банды. Ночь = штурм-банда с 1 фронта на лагерь. Для теста ночной осады без ожидания дня.",
		"сменить фазу",
		wd,
		func(): wd.cheat_toggle_phase(),
	))
	list.add_child(_build_cheat_card(
		"+100 скелетов",
	...
	list.add_child(_build_cheat_card(
		"Бесплатная стройка",
		"Toggle: ВКЛ — площадки достраиваются мгновенно; ВЫКЛ — здание возводится само за build_time (призрак растёт, скелеты могут сорвать). Действует на НОВЫЕ установки.",
		fb_label,
		self,
