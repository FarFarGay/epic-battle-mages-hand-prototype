...
## Сколько собирателей-гномов живёт в этой палатке. Camp читает это значение
## в своём _spawn_gnomes() и инстанцирует gnome_scene нужное количество раз.
## Лучники — отдельный отряд через recruit_squad, не привязаны к палаткам.
