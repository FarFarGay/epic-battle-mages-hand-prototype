...
## 0.7с (а не 0.35) — после скелетного point-blank trigger'а и AoE strike'а
## копейщик нуждается в реальном «окне расплаты»: drift 0.25 + recovery 0.7 =
## 0.95с уязвимости. Скелет windup 0.32-0.48с укладывается в окно дважды —
## один strike гарантированно, второй возможен при удачном тайминге.
