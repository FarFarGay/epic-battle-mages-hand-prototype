...
## 1.8× — заметная просадка точности, стимул выстраивать формации, но
## защитник не «слепой» в патруле. 2026-05-15: 2.5 → 1.8 — на base 0.4м это
## даёт 0.72м wandering vs 0.4м formation (~30% попадания в упор vs 64%).
const WANDERING_INACCURACY_MULT: float = 1.8
