...
# Зона добычи (диск+кольцо вокруг башни при aim'е рабочих + гейт «источник вне
# радиуса») ВЫРЕЗАНА 2026-07-07 по фидбеку «зона нахуй не нужна»: приказ
# выполняется без ограничения радиусом башни (leash-радиусы отряда остаются).
