...
## Множитель урона стрелы ПО ЩИТУ щитовика (карточка «Щитобой», данж-WASD).
## 1.0 = как есть; аддитивное поле, основная игра не затронута. Стрела читает
## его у своего стрелка через shooter_ref.
var shield_damage_mult: float = 1.0
