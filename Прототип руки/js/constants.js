...
export const FIREBALL_TILE_RADIUS   = 2.5;   // радиус трансформации тайлов при взрыве
...
export const WIND_SPELL_COOLDOWN    = 5.0;   // перезарядка (сек)
export const WIND_KNOCKBACK_FORCE   = 8.0;   // сила отталкивания юнитов

// — Мана —
export const MANA_MAX           = 1000;  // максимальный запас маны
export const MANA_FIREBALL_COST = 500;   // стоимость огненного шара (50% маны)
export const MANA_WATER_COST    = 300;   // стоимость заклинания воды
export const MANA_EARTH_COST    = 400;   // стоимость заклинания земли
export const MANA_WIND_COST     = 200;   // стоимость заклинания ветра
