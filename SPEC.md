...
#### 5.22.8 Нефтесеть — хребет геймлупа (Room8 коллектор ← трубы ← буры на месторождениях) (2026-06-23) (`oil_collector.gd`, `oil_deposit.gd`, `oil_rig.gd`, `pipe_segment.gd`, `hand_place_aim.gd`, `oil_grid_preview.gd`, `shaders/build_grid.gdshader`)
