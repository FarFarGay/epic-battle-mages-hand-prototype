...
- **Крупные враги**: гигант и гигант-метатель (`super_dash_only`) — цепляются и тянутся; мех — рвёт верёвку весом (канон apex). ⚠ ОБЫЧНЫЙ камнеметатель (240 hp, НЕ в super_dash_only) сейчас «мелочь»: пробой 60 урона без ваншота и без зацепа — невнятная середина. PENDING решение юзера: перевести в heavy-ветку (правило-кандидат «что не ваншотится — цепляется», hp-порог вместо списков; «выдернуть снайпера из тыла» = вкусный кейс).
