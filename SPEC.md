...
**Актуальные (акт II «Долина», 2026-07-07 ночь — ЦИКЛ ЗАМКНУТ, идёт плейтест юзера):**

- **⭐ СТАТУС: акт II проходится целиком** (§5.27.11): пещера → долина → замок → ночь → 3 вылазки → мех → выход-победа. Всё в наброске — тюнинг СТРОГО по точечным замечаниям юзера с плейтеста, вперёд не бежать.
