...
- **Секции-категории** (`BUILD_SECTIONS`, та же таксономия `PadBuilding.category`): ⛏ ДОБЫЧА (шахта/плавильня/двор) · 🛡 ОБОРОНА (стены/ворота/казармы/барак) · 🏰 ЗАМОК·СОЦИУМ (качалка/дом) · 🌉 ИНЖЕНЕРИЯ (мост). Под заголовком — карточки в GridContainer.
